...
const (
	...
	UPDATECPAREPORTSUMMARYCAMPAIGN = "UPDATE campaign_detail SET cost_per_conversion = '%s', agency_fee = '%s' WHERE DATE(summary_date) = '%s' AND urlservicekey = '%s' AND country = '%s' AND operator = '%s' AND partner = '%s' AND adnet = '%s' AND service = '%s' AND campaign_id = '%s'"
)
