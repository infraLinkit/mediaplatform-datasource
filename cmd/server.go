...
var serverCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		// Migrate table
		c.DB.AutoMigrate(&entity.Campaign{}, &entity.CampaignDetail{}, &entity.MO{}, &entity.PixelStorage{}, &entity.Postback{}, &entity.SummaryCampaign{}, &entity.DataClicked{}, &entity.DataLanding{}, &entity.DataRedirect{}, &entity.DataTraffic{}, &entity.ApiPinReport{}, &entity.ApiPinPerformance{}, &entity.Menu{}, &entity.Role{}, &entity.Permission{})
